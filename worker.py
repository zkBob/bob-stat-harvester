...
MEASUREMENTS_INTERVAL = getenv('MEASUREMENTS_INTERVAL', 60 * 60 * 2 - 30)
COINGECKO_RETRY_ATTEMPTS = getenv('COINGECKO_RETRY_ATTEMPTS', 2)
COINGECKO_RETRY_DELAY = getenv('COINGECKO_RETRY_DELAY', 5)
WEB3_RETRY_ATTEMPTS = getenv('WEB3_RETRY_ATTEMPTS', 2)
WEB3_RETRY_DELAY = getenv('WEB3_RETRY_DELAY', 5)
